...
class MicrosoftWebView extends StatefulWidget {
  ...
  const MicrosoftWebView({super.key, required this.serviceName});

  @override
  State<MicrosoftWebView> createState() => _MicrosoftWebViewState();
}
...
class _MicrosoftWebViewState extends State<MicrosoftWebView> {
  ...
  void initState() {
    ...
    String userag = '';
    super.initState();
    print('${currentUrl}microsoft/auth?token=$authToken');
    controller = WebViewController()
      ..setJavaScriptMode(JavaScriptMode.unrestricted)
      ..loadRequest(Uri.parse('${currentUrl}/microsoft/auth?token=$authToken'))
      // ..getUserAgent();
