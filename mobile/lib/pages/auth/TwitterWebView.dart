...
class TwitterWebView extends StatefulWidget {
  ...
  const TwitterWebView({super.key, required this.serviceName});

  @override
  State<TwitterWebView> createState() => _TwitterWebViewState();
}
...
class _TwitterWebViewState extends State<TwitterWebView> {
  ...
  void initState() {
    ...
    String userag = '';
    super.initState();
    print('${currentUrl}twitter/auth?token=$authToken');
    controller = WebViewController()
      ..setJavaScriptMode(JavaScriptMode.unrestricted)
      ..loadRequest(Uri.parse('${currentUrl}/twitter/auth?token=$authToken'))
      // ..getUserAgent();
