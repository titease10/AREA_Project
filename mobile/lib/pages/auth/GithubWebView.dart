...
class GithubWebView extends StatefulWidget {
  ...
  const GithubWebView({super.key, required this.serviceName});
...
class _GithubWebViewState extends State<GithubWebView> {
  ...
  void initState() {
    ...
    String userag = '';
    super.initState();
    print('${currentUrl}/github/auth?token=$authToken');
    controller = WebViewController()
      ..setJavaScriptMode(JavaScriptMode.unrestricted)
      ..loadRequest(Uri.parse('${currentUrl}/github/auth?token=$authToken'))
      // ..getUserAgent();
